...
if($cid != NULL){
	...
	if($cid != NULL){
		echo "<h3 class='tcenter'>La prossima consegna avr&agrave; inizio il " . strftime("%e %B %G", strtotime($cid['starttime'])) . " alle " . strftime("%R", strtotime($cid['starttime'])) . "</h3>";
	} else {
		echo "<h3 class='tcenter'>Nessuna consegna aperta e/o prevista al momento</h3>";		
	}
	echo "<div class='vspace50'></div>";
	echo "<div class='clear'></div>";
}
