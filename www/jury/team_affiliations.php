 ...
 *
 * $Id: team_affiliations.php 3209 2010-06-12 00:13:43Z eldering $
 *
...
echo "<h1>Affiliations <img src='../images/team_affiliation.png' style='vertical-align:middle;'></img></h1>\n\n";
...
if( $res->count() == 0 ) {
	...
	echo "<table class=\"list sortable\">\n<thead>\n" .
		...
		"<th>country</th>" .
		"<th>#teams</th><th>edit</th><th>del</th></tr>\n</thead>\n<tbody>\n";
	...
	while($row = $res->next()) {
		...
		if ( IS_ADMIN ) {
			echo "<td class=\"editdel acenter\">" .
				editLink('team_affiliation', $row['affilid']) . "</td><td class='editdel acenter'>" .
